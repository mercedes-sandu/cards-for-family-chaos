...
namespace Utility
{
    public static class GameEvent
    {
        ...
        /// </summary>
        public delegate void CardSelectedHandler(Card cardTemplate, int weekNumber);
        ...
        public static void HoverChoice(Choice choice, bool enteringHover, bool towardChoiceOne) =>
            OnChoiceHover?.Invoke(choice, enteringHover, towardChoiceOne);
